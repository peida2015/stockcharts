  ...
  GraphBuilder.prototype = {
    ...
    drawSymbol: function () {
      ...
      symb.append('image').attr('class', "searchIcon").attr('x', -25)
        ...
        .attr('height', '20')
        .attr('width', '20')
        .attr('xlink:href', "/assets/search-aa9a3daf8ebd8633dc414f659765dd9efe306432a3e8f3c8a5ce3dfd6a36a711.jpg");;
    ...
    drawChartTypeSelector: function () {
      ...
      var lineIcon = chartIcons.append('image')
        ...
        .attr('height', '35')
        .attr('width', '35')
        .attr('xlink:href', "/assets/lg-icon-6577e98681527f5b58a4ef50f2fda78fb6a4ddf55acb82b91b6785b54377a6f7.png");
      ...
      var candlestickIcon = chartIcons.append('image')
        ...
        .attr('height', '35')
        .attr('width', '35')
        .attr('xlink:href', "/assets/cs-icon-663bfefe6171e3f0c6236c69142810a8952491e5d3d89d20504ca8824707459a.png");
